...
Motivated by the significant spread of open cluster metallicities at the solar radius beyond observational uncertainty, we are now turning to the scatter of the radial metallicity gradient.

In this section, we investigate
\begin{itemize}
    \item the change of scatter from the innermost radii to the outermost (see Fig.~\ref{{fig:global_r_feh_fit}}c). We see a steady increase in $1-\sigma$ spread of \input{tex_text/fe_h_spread_0kpc} at $R_\mathrm{Gal.} = 0.25 \pm 0.25\,\mathrm{kpc}$, \input{tex_text/fe_h_spread_8kpc} at $R_\mathrm{Gal.} = 8.25 \pm 0.25\,\mathrm{kpc}$, to \input{tex_text/fe_h_spread_19kpc} at $R_\mathrm{Gal.} = 19.5 \pm 0.25\,\mathrm{kpc}$.
\end{itemize}
