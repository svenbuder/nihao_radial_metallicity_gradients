...
\SB{Intro by \citet{Moran2012}: "A proper characterization of the ages and metallicities of the stars in spiral galaxies, as well as the radial dependence of the metallicity of stars and gas in these systems, has long been recognized as a key stepping-stone to unraveling disk galaxy formation processes, including the roles of gas accretion, supernovae-driven outflows and the radial migration of stars (Quirk \& Tinsley 1973; Tinsley 1980; Lacey \& Fall 1985; Wyse \& Silk 1989; Kauffmann 1996; Chiappini et al. 1997; Schoenrich \& Binney 2009)."}
...
\SB{Possible reasons for a break radius: inside-out galaxy formation, secular evolution and radial migration based on spiral arms and bar influence, outer disk growth during low-metallicity gas inflow, and mergers generally:
\begin{itemize}
    \item Star Formation Efficiency Variations: \citep{Sanchez2014} and \citep{Ho2015}
    % 1. **Star Formation Efficiency Variations**:
    %    - **Sánchez, S. F., et al. (2014)**: "The dependence of galaxy metallicity on stellar mass and star formation rate: exploring the connections with local and global environment" in *Astronomy & Astrophysics*. This paper discusses how star formation efficiency can vary with radius and influence metallicity gradients.
    %    - **Ho, I-T., et al. (2015)**: "SDSS-IV MaNGA: A Characteristic Metallicity Gradient in Star-forming Galaxies" in *The Astrophysical Journal*. This study discusses variations in star formation efficiency and its impact on the observed metallicity gradients.
    \item Gas Accretion and Dilution: \citep{Sanchez2013} and \citep{Belfiore2016}
    % 2. **Gas Accretion and Dilution**:
    %    - **Sánchez, S. F., et al. (2013)**: "The discovery of an anti-correlation between the metallicity of galaxies and the amount of gas inflow" in *Astronomy & Astrophysics*. This paper discusses how inflow of metal-poor gas into the outer regions of galaxies can flatten metallicity gradients.
    %    - **Belfiore, F., et al. (2016)**: "The SDSS-IV MaNGA survey: global and local relations between gas-phase metallicity and stellar mass" in *Monthly Notices of the Royal Astronomical Society*. This study explores how recent gas accretion events can lead to breaks in the metallicity gradient.
    \item Localized Star Formation Bursts: \citep{SanchezBlazquez2014}
    % 3. **Localized Star Formation Bursts**:
    %    - **Sánchez-Blázquez, P., et al. (2014)**: "The CALIFA survey across the Hubble sequence: spatially resolved stellar population properties in galaxies" in *Astronomy & Astrophysics*. This paper discusses the impact of localized star formation bursts on the metallicity gradient.
    %    - **Pilyugin, L. S., et al. (2014)**: "The radial abundance gradient in M31, the Andromeda galaxy" in *Monthly Notices of the Royal Astronomical Society*. This study investigates localized bursts of star formation and their impact on the radial metallicity gradient.
    \item Radial Variations in Gas Inflow Rates: \citep{SanchezMenguiano2016} and \citep{Bresolin2012}
    % 4. **Radial Variations in Gas Inflow Rates**:
    %    - **Sánchez-Menguiano, L., et al. (2016)**: "Breaks in the abundance gradients of spiral galaxies" in *Astronomy & Astrophysics*. This paper discusses how variations in gas inflow rates at different radii can lead to breaks in the metallicity gradient.
    %    - **Bresolin, F., et al. (2012)**: "The flattening of galaxy abundance gradients with redshift" in *The Astrophysical Journal*. This paper explores the impact of radial variations in gas inflow rates on metallicity gradients.
    \item Disk Instabilities: \citep{Grand2016}
    % 5. **Disk Instabilities**:
    %    - **Foyle, K., et al. (2010)**: "The effect of spiral arms on star formation in M51" in *The Astrophysical Journal*. This study looks at how disk instabilities associated with spiral arms can lead to variations in metallicity gradients.
    %    - **Grand, R. J. J., et al. (2016)**: "The importance of radially and temporally varying radial migration for the formation of disc galaxies" in *Monthly Notices of the Royal Astronomical Society*. Although more focused on older stars, this paper discusses how disk instabilities can influence radial distributions.
    \item Gas Outflows and Feedback: \citep{Lilly2013} and \citep{Ma2017b}
    % 6. **Gas Outflows and Feedback**:
    %    - **Lilly, S. J., et al. (2013)**: "Gas Regulation of Galaxies: The Evolution of the Cosmic Specific Star Formation Rate, the Metallicity-Mass-Star-formation Rate Relation, and the Stellar Content of Halos" in *The Astrophysical Journal*. This study discusses the role of feedback and outflows in shaping metallicity gradients.
    %    - **Ma, X., et al. (2017)**: "The Origin and Evolution of the Galaxy Mass-Metallicity Relation: The Role of Supernova Feedback in Gas-Phase Metallicity" in *Monthly Notices of the Royal Astronomical Society*. This paper looks at the role of supernova feedback in driving outflows and shaping the metallicity gradient.
\end{itemize}
}

\SB{Shape:
\begin{itemize}
    \item "bends" \citep{Pilyugin2003}
    \item different shapes and even sequences of shapes: \citep{Pilyugin2017, Pilyugin2024} with isophotal radius $R_g \equiv R_{25}$
    \item Piecewise Linear Fits: \citep{SanchezMenguiano2016}
    \item Comparison of Fit Models: \citep{RosalesOrtega2011}, look also at other papers of this series by \citet{Sanchez2011} and \citet{SanchezBlazquez2014b}
    \item Non-linear Methods: \citep{Scarano2013} - connect it with corotation radius.
    \item Change Point Detection Algorithms: \citep{Moran2012} - rather flat when plotted with respect to $R_{90}$ (90\% of the galaxy's r-band light).
    \item Direct Observation of Flattening: \citep{Bresolin2012}, e.g. for M83
\end{itemize}
}
...
%     \item \input{tex_text/maximum_scatter_ages.tex}
...
% \citet{Sanchez2014} analysed a sample of 306 galaxies and found that breaks in metallicity gradients are common in both spiral and barred galaxies, often occurring at radii between 1 and 2 effective radii (Re): "Beyond $\sim 2$ disk effective radii our data show evidence of a flattening in the abundance" What is effective radius? $R_e$ is half-light radius. \citet{Chen2023} used $R_{25} = 3.6 R_e$ \citetp{Williams2009}.
