...
Here (Fig.~\ref{fig:global_r_feh_fit}), we are using the \textsc{LinearRegression} module of \textsc{sklearn.linear_model} \citep{scikit-learn}.
...
\label{sec:age_position_radial_metallicity_gradients}
