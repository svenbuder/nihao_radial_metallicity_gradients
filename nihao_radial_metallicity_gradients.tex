...
\begin{figure}
    ...
    \caption{Same as Fig.~\ref{fig:global_r_feh_fit}c, but overplotting the different functions (linear, quadratic, and piecewise linear) estimated from the full distribution (solid lines) or from means and standard deviations in $\Delta R_\mathrm{Gal.} = 0.5\,\mathrm{kpc}$ bins (dashed lines).}
