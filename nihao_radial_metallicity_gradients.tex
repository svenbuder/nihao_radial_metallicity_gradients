...
\SB{Maybe also include gas metallicity gradient? Fig.~\ref{fig:global_r_feh_fit_gas}. Gas gradient is interestingly only linear! Is 0.0134 the correct normalisation value for solar metallicity? That's the value from \citet{Asplund2009}.}
