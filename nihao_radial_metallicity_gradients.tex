...
\SB{Fig.~\ref{fig:radial_metallicity_gradients_mw_vs_nihao}: explanation for young cluster outliers due to spiral arms (trace back spiral arms?). Localised effect could also mimic non-linear shapes and more spatial coverage is needed in the Milky Way!}
