...
\author{\vspace{-1.6cm}Sven Buder$^{1,2,*}$\orcidlink{0000-0002-4031-8553}}
...
\input{tex_text/fe_h_spread_at_R_0kpc} at $R_\mathrm{Gal.} = ~~0.25 \pm 0.25\,\mathrm{kpc}$ to \\
\input{tex_text/fe_h_spread_at_R_8kpc} at $R_\mathrm{Gal.} = ~~8.25 \pm 0.25\,\mathrm{kpc}$ and reaches \\
\input{tex_text/fe_h_spread_at_R_19kpc} at $R_\mathrm{Gal.} = 19.75 \pm 0.25\,\mathrm{kpc}$.
...
\begin{figure}
    \centering
    \includegraphics[width=0.96\columnwidth]{figures/overlap_local_variation_gas.png}
