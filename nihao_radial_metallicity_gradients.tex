...
\begin{itemize}
    ...
    \item We trace the position of Groups 1, 2, and 3 in the spatial dimension $\varphi_\mathrm{Gal.}-R_\mathrm{Gal.}$ in Fig.~\ref{phi_angle_R_follow_up} and confirm that they are connected.
    \item What does that mean for studies with open clusters in the Milky Way?
\end{itemize}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/phi_angle_R_follow_up.png}
    \caption{Distribution of young stars in the azimuthal and radial direction.}
...
\begin{itemize}
    ...
    \item Break radius $R_\mathrm{break} \sim 10\,\mathrm{kpc}$ hard to fit.
    \item What would the break radius mean physically at this distance? -> \citet{Grand2016, Chen2023}, Bar length? Disk length? Co-rotation radius? \SB{Add these quantities as dashed lines in the $R_\mathrm{Gal.}$ diagrams?}
...
\subsection{Localised vertical and azimuthal deviations} \label{sec:discussion_coherence_position}
...
\subsection{The impact of time and age}

\begin{itemize}
    \item Fig.~\ref{fig:quadratic_fit_across_maximum_ages}
\end{itemize}
