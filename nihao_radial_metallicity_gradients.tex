...
Sven Buder,$^{1,2,5}$\thanks{E-mail: sven.buder@anu.edu.au} and
Tobias Buck,$^{3,4}$
...
\begin{itemize}
    \item Piecewise linear and quadratic functions perform both better than a linear fit to the radial metallicity relation. However, we see no significant preference between piecewise and quadratic functions based on our assessments. \SB{Discussion outcome}
